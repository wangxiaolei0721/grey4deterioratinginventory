function residual = lambda_residual(time0,time_train,p_vector_train,demand_train,level_diff_train,level_train,weight,lambda)
...
% demand residual
demand_residual=weight(1)*(Y_demand-H_lambda*estimates);
% inventory residual
inventory_residual=weight(2)*(Y_inventory_diff-H_inventory*lambda);
