function [lambda_initial,res_var] = lambda_initial(time0,time_train,demand_train,level_diff_train,level_train)
...
lambda_initial = (H_inventory'*H_inventory)\H_inventory'*Y_inventory_diff;
residual =  Y_inventory_diff-H_inventory*lambda_initial;
