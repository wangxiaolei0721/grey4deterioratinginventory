function res_var = lambda_inventoryres(time0,time_train,demand_train,level_diff_train,level_train,lambda)
% calculate the residual variance of inventory regression equation based on lambda
% input parameter:
...
residual =  Y_inventory_diff-H_inventory*lambda;
